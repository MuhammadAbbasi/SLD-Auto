# -*- coding: utf-8 -*-
"""
sld_gui_v3.py  -  Upgraded GUI front-end and CAD engine for the DC Single Line Diagram generator.
Run:  python sld_gui_v3.py
"""
    ...
    if port1_ys and last_m in mppt_map:
        ...
        if missing:
            ...
            if ref_p1:
                ...
                # Collect prototype row entities (from the last template MPPT row) to replicate
                proto_last_m = last_m
...
class SLDAppV3(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("A176LAB - DC Single Line Diagram Generator v3")
    ...
    def _build_equip_tab(self, nb):
        ...
        self.f_max_mppts = _FieldRow(tab, "Inverter Max MPPTs:", "Auto",
                                     unit="channels ('Auto' or numeric, e.g. 12)", width=14)
        self.f_max_mppts.pack(fill='x')
