# -*- coding: utf-8 -*-
"""
sld_gui_v6.py  -  Upgraded GUI and CLI Generator for DC Single Line Diagrams  v6
=============================================================================
Geometry and design are loaded directly and stamped from the template DXF,
ensuring the original drawing style remains exactly the same.

GUI:  python sld_gui_v6.py
CLI:  python sld_gui_v6.py --excel <excel_path> [options]
"""
...
_DEFAULT_TEMPLATE = r'\\S01\2 privato\2025.046 - Sunnerg YANEL\26S001_2E103 - DC Single Line Diagram.dxf'
...
class SLDAppV6(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("A176LAB - DC Single Line Diagram Generator v6")
    ...
    def _add_header(self):
        ...
        ttk.Label(txt, text="DC Single Line Diagram Generator v6",
...
def _build_cli():
    p = argparse.ArgumentParser(
        prog='sld_gui_v6.py',
        description='DC Single Line Diagram Generator v6 (Template-Based)',
    )
